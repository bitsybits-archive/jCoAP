...
public class CoapResponse extends AbstractCoapMessage {
	...
	public CoapResponse(byte[] bytes, int length){
		this(bytes, length, 0);
	}
	
	public CoapResponse(byte[] bytes, int length, int offset){
	...
	public CoapResponse(CoapPacketType packetType, CoapResponseCode responseCode, int messageId) {
		this.version = 1;
		this.optionCount = 0;
